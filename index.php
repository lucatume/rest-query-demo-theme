...
<nav class='container row' id='nav'>
	<form action="/" method="GET" class="medium-8 medium-centered columns">
		<fieldset role="search">
			<input class="search" type="text" name="s" placeholder="Search me: no JavaScript for you though."/>
		</fieldset>
	</form>
</nav>
...
<footer class='container row' id='footer'>
	<section class="medium-8 medium-centered columns text-center">
		...
		<p>Made with <a href="http://wordpress.org">WordPress</a> and the amazing <a href="https://wordpress.org/plugins/rest-api/">REST API</a>.</p>
	</section>
</footer>
