var $ = require( 'jQuery' ), restData, Backbone = require( 'backbone' ), Twig;
...
$( document ).ready( function () {
	...
	var template = Twig.twig( {id: content, autoescape: false, data: $( '#tpl-content' ).html()} );
	...
	var rqdRouter = Backbone.Router.extend( {
		...
		index: function ( searchString ) {
			...
			this.restEndpoint.getPostsData( args ).done( function ( data ) {
				var content = self.template.render( {posts: data} );
